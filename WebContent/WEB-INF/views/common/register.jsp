	...
	<form id="inputForm" action="${ctx}/register" method="post" class="form-horizontal">
		<fieldset>
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" id="loginName" name="mobile" class="input-large required" minlength="3"/>
				</div>
			</div>
			<div class="control-group">
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="password" id="confirmPassword" name="password" class="input-large required" equalTo="#plainPassword"/>
				</div>
			</div>
