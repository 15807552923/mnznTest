			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-user"></i>经销商列表</h2>
						<div class="box-icon">
					...
					<div class="row-fluid show-grid">
						<div class="span12" >	
						  	<shiro:hasRole name="super">
						  	  <a href="${ctx}/pro/dealerAdd.mn" style="color: #fff;"> <button class="btn btn-small btn-success" style="float: left; margin-left: 20px;">增加+</button></a>
						 	 </shiro:hasRole>
						</div>
			       </div>
						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						 ...
						 <c:forEach var="user" items="${userList}" varStatus="u" >
							<tr>
								...
								<td class="center">
									<a class="btn btn-mini btn-info" href="${ctx}/pro/dealerEdit.mn?localId=${user[0]}">
										<i class="icon-edit icon-white"></i>  
										修改                                            
									</a>
									<a class="btn btn-mini btn-primary" href="${ctx}/pro/listMyDealers.mn?localid=${user[0]}">
