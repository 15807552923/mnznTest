		...
		<div class="row-fluid sortable">
			<div class="box span12">
				...
				<div class="box-content">
					<form id="validForm" class="form-horizontal" action="${ctx}/pro/${op=='edit' ? 'operatorUpdate' : 'operatorSave'}.mn" method="post">
						<fieldset>
							...
							<div class="control-group">											
								<label class="control-label" for="name">运营商名称<em class="required">*</em></label>
								<div class="controls">
									<input type="text" class="fn-tinput" name="name" value="${operator.name}" />
								</div> <!-- /controls -->				
							</div> <!-- /control-group -->
							...
							<div class="control-group">											
								...
								<div class="controls">
									<input type="text" class="fn-tinput" name="contcat" value="${operator.contcat}" />
								</div> <!-- /controls -->				
							</div> <!-- /control-group -->
							...
							<div class="control-group">											
								...
								<div class="controls">
									<input type="text" class="fn-tinput" name="address" value="${operator.address}" />
								</div> <!-- /controls -->				
							</div> <!-- /control-group -->
							...
							<div class="control-group">											
								...
								<div class="controls">
									<input type="text" id="mobile" name="mobile" class="fn-tinput" placeholder="手机号" value="${operator.mobile}"  />
							...
							<div class="control-group">											
								...
								<div class="controls">
									<input type="text" class="fn-tinput" name="servicephone" value="${operator.servicephone }" />
								</div> <!-- /controls -->				
							</div> <!-- /control-group -->
