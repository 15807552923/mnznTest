...
<body>
		...
		<div class="row-fluid ">
			<div class="box span12">
				<div class="box-header well" data-original-title>
					<h2>
						<i class="icon-user"></i>结账金额----${billDate}
					</h2>
					<div class="box-icon">
				...
				<p>
		           <a class="btn btn-success" onclick="getXlsFromTbl('transferDetail',null)"><span>导出EXCEL</span></a>
	            </p>
	...
	<input type="hidden" value="${billDate}" id="billDate" />
	...
	<script type="text/javascript">
      ...
      function a_transferDetail(){
    	  var page = $("#page").val();
    	  var billDate = $("#billDate").val();
    	  var searchStr = $("#searchStr").val();
    	  $.ajax({
    		    type : "POST",  
    		    url : "${ctx}/bill/a_transferDetail.mn",
    		    data : {page:page,searchStr:searchStr,billDate:billDate}, 
    		    dataType: "json",  
    		    success : function(data) {
    		    	if(data.length > 0){
    		    	 	var html="";
